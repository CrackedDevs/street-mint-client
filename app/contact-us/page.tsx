  ...
  return (
    <div className="min-h-screen bg-white flex items-center justify-center px-4">
      <div className="max-w-md w-full space-y-8">
        ...
        <form id="contact-form" className="mt-8 space-y-6" onSubmit={handleSubmit}>
        ...
        {status && (
          <div className={`mt-4 text-center text-lg font-medium ${status.success ? "text-green-600" : "text-red-600"}`}>
            {status.message}
          </div>
        )}
      </div>
